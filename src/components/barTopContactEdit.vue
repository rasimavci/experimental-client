<template>
  <header class="bar bar-nav bar-easy-vue">
    ...
    <a class="icon icon-check pull-right" v-if="showWriteIcon" @click="goContactDetail"></a>
...
export default {
  ...
  methods:{
    writeSome: function() {
      this.$store.commit('isShowAlert3', true);
    },
    refresh: function() {
    ...
    goContactDetail(){
     // this.$store.commit('SAVE_USER', contact); 
      this.$router.push('contactdetail')
    },      
  }
}
</script>
